...
String sql="insert into agent(user_id,password,first_name,middle_name,last_name,gender,dob,address1,address2,city,state,country,pincode,phone,mobile_no,email,occupation,annualincome) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?);";
        try{
