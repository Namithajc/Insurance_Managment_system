...
PreparedStatement pst;
  ...
  String sql="insert into agent_info(agent_id,password,first_name,middle_name,last_name,gender,address_line,address_line2,city,state,country,pincode,phone,mobile,email,date_of_birth,branch_id) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?);";
        try{
